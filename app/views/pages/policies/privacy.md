...
- IPアドレス（アカウントの不正利用の防止、セキュリティ監視、ならびに不正アクセス発生時の調査対応のため）
...
当方は、お問い合わせの受付にGoogle Forms（Google LLC）を利用しています。
フォームに入力された情報（メールアドレス、お問い合わせ本文、該当投稿のURLなど）は
Googleのサーバーに送信され、お問い合わせへの対応目的にのみ利用します。
...
当方は、Google及びそのパートナー（第三者配信事業者）の提供する広告を設置しています。広告配信にはCookieを使用し、お客様が過去に当方ウェブサイトやその他のサイトにアクセスした情報に基づいて広告を配信します。Google やそのパートナーは、Cookieを使用することにより適切な広告を表示しています。
