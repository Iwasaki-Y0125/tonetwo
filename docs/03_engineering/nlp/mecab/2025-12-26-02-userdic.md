...
- ユーザー辞書作成・動作確認・トラブルシュート（mecab-dict-indexの場所特定など）のメモを追加([2026-03-08-01-mecab-userdic-runbook.md](./2026-03-08-01-mecab-userdic-runbook.md))

## 導入手順
[2026-03-08-01-mecab-userdic-runbook.md](./2026-03-08-01-mecab-userdic-runbook.md) を確認
...
## 補足
- `mecab-dict-index: command not found` の場合は `mecab-config --libexecdir` から実体パスを特定して実行しました。（詳細は [2026-03-08-01-mecab-userdic-runbook.md](./2026-03-08-01-mecab-userdic-runbook.md) の補足を参照）
